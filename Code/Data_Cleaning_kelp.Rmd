...
library(lubridate)
library(zoo)
MasterData <- read_excel("C:/Users/sellkes/Documents/GitHub/Dotson_SURE_Kelp_Nutrients/Data/Master_Data_Sheet_KRC_1.xlsx") # you will have to change the directory to where you saved the file, then you should be able to upload
...
chlData <- read.csv(".//Chlorophyll_data_fieldfluro_clean.csv")
